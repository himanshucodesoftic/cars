        ...
        <!-- header wrapper -->
            <div class="header-wrapper flex items-center justify-between">
                ...
                <div class="flex-shrink-0 flex items-center">
                  <img class="block lg:hidden h-10 w-auto" src="{{asset('https://redautorent.ee/wp-content/uploads/2021/02/output-onlinepngtools-4.png')}}" alt="RedAuto Rent Logo">
                  <img class="hidden lg:block h-20 w-auto" src="{{asset('https://redautorent.ee/wp-content/uploads/2021/02/output-onlinepngtools-4.png')}}" alt="RedAuto Rent Logo">
                ...
                <navbar class="navbar hidden md:block">
                    <ul class="flex space-x-8 text-sm font-semibold">
                        <li><a href="{{url('index')}}" class="active border-b-2 border-orange-500 pb-2">@lang('home.Home')</a></li>
                        ...
                        <li>
                          <div class="dropdown inline-block relative -mt-8">
                            <button class="button cta bg-orange-500 hover:bg-orange-600 px-3 py-2 rounded text-white font-normal inline-flex items-center">
                              <span class="mr-1">@lang('home.country')</span>
            ...
            <div class="social flex space-x-5 mt-4 ">
                <a href="#">
                    <svg 
                        ...
                        xmlns="{{asset('http://www.w3.org/2000/svg')}}" viewBox="0 0 512 512">
                ...
                <a href="#">
                    <svg 
                        ...
                        class="h-5 w-5 fill-current text-gray-600" role="img" 
                        xmlns="{{asset('http://www.w3.org/2000/svg')}}" viewBox="0 0 320 512">
                ...
                <a href="#">
                    <svg 
                        ...
                        class="h-5 w-5 fill-current text-gray-600" role="img" 
                        xmlns="{{asset('http://www.w3.org/2000/svg')}}" viewBox="0 0 448 512">
                ...
                <a href="#">
                    <svg 
                        ...
                        class="h-5 w-5 fill-current text-gray-600" role="img" 
                        xmlns="{{asset('http://www.w3.org/2000/svg')}}" viewBox="0 0 576 512">
